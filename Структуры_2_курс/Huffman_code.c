...
int main() {
    ...
    printf("Построение кода Хаффмана...\n");
    ...
    fano(P, codes_fano_std, lengths_fano_std, 0, n-1, 0);

    double kraft_sum_huff = 0, entropy = 0, avg_len_huff = 0.2;
    ...
    printf("║                             КОД ХАФФМАНА                                    ║\n");
    printf("╠══════════╦═════════════════╦══════════════════════╦════════════════════════╣\n");
    printf("║  Символ  ║   Вероятность   ║    Кодовое слово     ║     Длина кода        ║\n");
    printf("╠══════════╬═════════════════╬══════════════════════╬════════════════════════╣\n");
    ...
    for (int i = 0; i < n; i++) {
        ...
        for (int j = 0; j < lengths_huffman[i]; j++)
            code_str[j] = codes_huffman[i][j] ? '1' : '0';
        code_str[lengths_huffman[i]] = '\0';

        printf(" ║ %15.6f ║ %-20s ║ %22d ║\n", P[i], code_str, lengths_huffman[i]);
    ...
    printf("\n╔════════════════════════════════════════════════════════════════════════════════════════╗\n");
    printf("║                   СРАВНИТЕЛЬНАЯ ТАБЛИЦА ХАРАКТЕРИСТИК КОДОВ                         ║\n");
    printf("╠═════════════╦══════════════════════╦════════════╦═════════════════╦══════════════════╣\n");
    printf("║    Метод    ║   Неравенство Крафта ║  Энтропия  ║ Средняя длина   ║   Избыточность   ║\n");
    printf("╠═════════════╬══════════════════════╬════════════╬═════════════════╬══════════════════╣\n");
    printf("║   Хаффман   ║ %20.6f ║ %10.6f ║ %15.6f ║ %16.6f ║\n", 
           kraft_sum_huff, entropy, avg_len_huff, redundancy_huff);
    printf("╟─────────────┼──────────────────────┼────────────┼─────────────────┼──────────────────╢\n");
    printf("║    Фано     ║ %20.6f ║ %10.6f ║ %15.6f ║ %16.6f ║\n", 
           kraft_sum_fano_std, entropy, avg_len_fano_std, redundancy_fano_std);
    printf("╟─────────────┼──────────────────────┼────────────┼─────────────────┼──────────────────╢\n");
    printf("║  Фано (A2)  ║ %20.6f ║ %10.6f ║ %15.6f ║ %16.6f ║\n", 
           kraft_sum_fano_a2, entropy, avg_len_fano_a2, redundancy_fano_a2);
    printf("╟─────────────┼──────────────────────┼────────────┼─────────────────┼──────────────────╢\n");
    printf("║   Шеннон    ║ %20.6f ║ %10.6f ║ %15.6f ║ %16.6f ║\n", 
    ...
    printf("╠══════════════════════════════════════════════════════════════╣\n");
    printf("║ Длина закодированной последовательности: %15ld бит ║\n", encoded_bits);
    printf("║ Коэффициент сжатия:                      %15.3f     ║\n", compression_ratio);
    printf("║ Эффективность кодирования:               %14.2f%%     ║\n", (entropy / avg_len_huff) * 100);
    printf("╚══════════════════════════════════════════════════════════════╝\n");
