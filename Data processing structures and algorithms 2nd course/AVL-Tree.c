...
int main() {
    ...
    printf("|______|______|____________|______|____________|\n");
    printf("| %s |  %d |    %d    |   %d  |    %.2f    |\n", 
           "ИСДП", balancedStats.size, balancedStats.sum, balancedStats.height, balancedStats.avg_height);
    printf("|______|______|____________|______|____________|\n");
    printf("|  %s |  %d |    %d    |   %d  |    %.2f    |\n", 
           "АВЛ", avlStats.size, avlStats.sum, avlStats.height, avlStats.avg_height);
    printf("|______|______|____________|______|____________|\n");
    freeTree(avlRoot);
